...
def find_minima_around_atom(box,file,move_atom,final_atom,neighbor_atoms):
    ...
    Find the lowest energy configuration for moving an atom to a location around another atom while avoiding testing locations near other atoms to improve efficiency.

    :param box - the box containing the atoms
    :param file - the file containing the atom information
    :param move_atom - the atom to move
    :param final_atom - the final atom
    :param neighbor_atoms - the neighboring atoms
    :return The minima around the specified atom
    """
...
def find_bond_preference(box,file,atom,midpoint,sepvec):
    #@TODO ADAM this is one of functions to fuck around with
    from sympy.abc import u,v
...
def load_data_from_csv(csvname):
    """
    Take a post neb csv file from my pipeline and read it into a datframe
    """
    global datafolder
...
def find_neighboring_sibc(atoms,oi):
    """
    Find neighboring silicon atoms which contain a BC vacancy bonded to a specific oxygen atom in a structure.
    :param atoms - the atoms in the structure
    :param oi - the index of the oxygen atom
    :return a list of neighboring silicon atoms bonded to the oxygen atom
    """
