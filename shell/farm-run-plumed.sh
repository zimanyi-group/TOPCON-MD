...
LOG_FILE=$CWD"/output/"$2.log
cp \$IN_FILE \$OUT_FOLDER

PLUMED_FILE=$CWD"/data/plumed_farm.dat"
cp \$PLUMED_FILE \$OUT_FOLDER
...
if srun /home/agoga/lammps-29Aug2024/build/lmp_mpi -nocite -log \$LOG_FILE -in \$FILENAME -var output_folder \$OUT_FOLDER ; 
